...
SECRET_KEY = 'django-insecure-$f^^!)*bifar1%op9ysnj8qdahzjzrkbgt(3_(qqu!4$^6rf1j'
DEBUG = True
ALLOWED_HOSTS = []
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'anyaliam50@gmail.com'
EMAIL_HOST_PASSWORD = 'xhcs csgb eilb fahs'
EMAIL_FROM = 'anyaliam50@gmail.com'
